        ...
        <div className="mt-16 grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {pillars.map((pillar, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="p-6 rounded-2xl bg-slate-50/50 border border-slate-100 hover:border-[#7C9A92]/30 hover:bg-[#7C9A92]/5 transition-all duration-300">
                <div className="w-12 h-12 rounded-xl bg-[#7C9A92]/10 flex items-center justify-center mb-5 group-hover:bg-[#7C9A92]/20 transition-colors">
                  <pillar.icon className="w-6 h-6 text-[#7C9A92]" />
                </div>
