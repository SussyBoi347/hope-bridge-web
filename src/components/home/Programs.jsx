  ...
  return (
    <section id="programs" className="py-24 lg:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <span className="text-sky-600 font-medium text-sm tracking-wide uppercase">
            What We Do
          </span>
        ...
        <div className="mt-16 grid md:grid-cols-2 gap-6">
          {programs.map((program, index) => (
            ...
            >
              <div className="relative h-full p-8 rounded-2xl bg-gradient-to-br from-white to-slate-50/50 border border-blue-100/40 hover:border-blue-200 hover:shadow-lg hover:shadow-blue-100/50 transition-all duration-300 overflow-hidden">
                {/* Gradient accent */}
                <div className={`absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r ${program.color} opacity-60 group-hover:opacity-100 transition-opacity`} />
                ...
                <div className="flex items-start justify-between mb-6">
                  ...
                  <ArrowUpRight className="w-5 h-5 text-blue-200 group-hover:text-blue-600 transition-colors" />
                </div>
