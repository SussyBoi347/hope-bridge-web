      ...
      <div className="flex flex-wrap gap-2">
        ...
        <motion.button
          ...
          onClick={() => {
            setQuery(suggestion);
            onSearch(suggestion);
          }} className="bg-cyan-500/10 text-slate-950 px-3 py-1.5 text-xs rounded-full hover:bg-cyan-500/20 border border-cyan-500/30 hover:border-cyan-400/50 transition-all">
