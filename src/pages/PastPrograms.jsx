          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12">
            ...
            <div className="max-w-3xl">
              <p className="text-white/80 text-lg leading-relaxed mb-4">
                We hosted over <span className="text-blue-300 font-bold">5 interactive drop-in sessions</span> at Key Clubs and student organizations across <span className="text-blue-300 font-bold">5 Lake Washington high schools</span> - Eastlake, Issaquah, Redmond, Skyline, and through the Sammamish Community Club, including the Eastlake Indian Student Association - reaching over <span className="text-blue-300 font-bold">150 students</span> directly. Each session brought HopeBridge into club meetings where we led discussions on our three core pillars: <span className="text-blue-300 font-semibold">cultural identity</span>, <span className="text-blue-300 font-semibold">academic pressure</span>, and <span className="text-blue-300 font-semibold">family disconnect</span>.
              </p>
            </div>
          </motion.div>
