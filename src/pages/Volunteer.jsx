    ...
    return (
      <div className="min-h-screen bg-blue-50 flex items-center justify-center px-6">
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="text-center max-w-md relative z-10">
          ...
          <h2 className="text-3xl font-bold text-blue-900 mb-4">Application Received!</h2>
          <p className="text-blue-700 mb-2">Thank you for wanting to volunteer with HopeBridge.</p>
          <p className="text-blue-600 text-sm">We will review your application and get back to you within 3-5 business days with next steps.</p>
        </motion.div>
      </div>
    );
  }
